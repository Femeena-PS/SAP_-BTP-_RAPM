...
define view entity ZATS_FM_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZATS_FM_BOOKING as _Booking
    on $projection.TravelId = _Booking.TravelId and
    $projection.BookingId = _Booking.BookingId
association[1..1] to ZATS_FM_TRAVEL as _Travel
