...
define view entity ZATS_FM_BOOKING as select from /dmo/booking_m
composition[0..*] of ZATS_FM_BOOKSUPPL as _BookingSuppl
association to parent ZATS_FM_TRAVEL as _Travel
...

{
   ...
   entity : {
         ...
         element: 'ConnectionID' }, additionalBinding: [{ 
