...
@EndUserText.label: 'Sales Basic Interface as Fact'
@Metadata.ignorePropagatedAnnotations: true
@VDM.viewType: #BASIC
@Analytics.dataCategory: #FACT
define view entity ZI_ATS_FM_SALES as select from zats_fm_so_hdr as head
association of one to many zats_fm_so_item as _Items
